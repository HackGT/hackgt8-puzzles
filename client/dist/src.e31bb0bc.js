...
function formatDate(date) {
  ...
  var formatted_date = date.getFullYear() + "-" + appendLeadingZeroes(date.getMonth() + 1) + "-" + appendLeadingZeroes(date.getDate()) + " " + appendLeadingZeroes(date.getHours()) + ":" + appendLeadingZeroes(date.getMinutes()) + ":" + appendLeadingZeroes(date.getSeconds()) + " " + ampm;
...
function getLeaderboard() {
  axios.get("http://localhost:3000/leaderboard", {
    ...
    var leaderboard_container = document.querySelector("#leaderboard-table");
    var table = document.querySelector("#leaderboard-data");
    console.log(response);
    var rows = response.data.data.users.map(function (row, index) {
      ...
      var pointElement = document.createElement("td");
...
function getUserStatus() {
  axios.get("http://localhost:3000/user/status", {
    ...
    var table = document.querySelector("#status-table-data");
    console.log(response.data.data);
    var rows = response.data.data.user.puzzlesCompleted.map(function (data, index) {
      var rowElement = document.createElement("tr");
      var puzzleElement = document.createElement("td");
